...
class UniteCreatorAddonView{
	...
	private function putHtml_generalSettings(){
		...
		<div class="uc-edit-addon-col uc-col-first">
			...
			<?php esc_html_e("Widget Type", "unlimited_elements");?>: <b> <?php echo esc_html($addonTypeTitle)?> </b>
	...
	private function putHtml_overviewTab(){
		...
		<div class="uc-tab-overview">
			...
			<div class="uc-section">
				<div class="uc-section-title"><?php esc_html_e("Widget Description", "unlimited_elements")?>:</div>
	...
	public function getBulkDialogContents($data){
		...
		<?php echo esc_html($paramType) ?> <?php _e("attribute","unlimited_elements")?>: <b> <?php echo esc_html($paramTitle)?> ( <?php echo esc_html($paramName)?> ) </b>
		<span class="hor_sap40"></span>
		<?php _e("Widget","unlimited_elements")?>: <b> <?php echo esc_html($addonTitle)?> </b>
		...
		<table class="unite_table_items">
			...
			<tr>
				...
				<th><b><?php esc_html_e("Widget Title", "unlimited_elements")?></b></th>
		...
		foreach($arrAddons as $index=>$catAddon){
			...
			$status = "<span class='unite-color-red'>".__("not exists","unlimited_elements")."</span>";
			if($isExists)
				$status = "<span class='unite-color-green'>".__("exists","unlimited_elements")."</span>";
		...
		<a href="javascript:void(0)" data-action="update" class="uc-action-button unite-button-primary"><?php esc_html_e("Add / Update in Widgets", "unlimited_elements")?></a>
		
		<span class="hor_sap40"></span>
		
		<a href="javascript:void(0)" data-action="delete" class="uc-action-button unite-button-secondary"><?php esc_html_e("Delete From Widgets", "unlimited_elements")?></a>
